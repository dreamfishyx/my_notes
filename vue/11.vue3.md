...
>      5.   但是在 js 代码中仍需要使用`.value`,此时可以通过 vscode 插件自动追加:<br><img src="./assets/image-20250307153309794.png" alt="image-20250307153309794" style="zoom:67%;" />
>
>   3.   当`ref()`包裹基本数据类型时：
>
...
> 此外，在使用 ts 的时候，我们需要对接受的参数进行类型约束或者默认值设置,如下：此处使用语法糖 setup
