...
GRUB_CMDLINE_LINUX_DEFAULT="loglevel=5 quiet snd_hda_intel.dmic_detect=0 snd_sof_pci.disable=1 snd_hda_intel.enable_msi=0 nvidia-drm.modeset=1"
...
4. 配置 hyprland 启动
   ...
   windowrule=move center,title:^(kitty_cava)$
   windowrule=size 800 500,title:^(kitty_cava)$
   windowrule=float,title:^(kitty_cava)$
   ```
