...
`hyprctl setcursor catppuccin-macchiato-blue-cursors 245 （光标名称、光标大小）
...
如果还是没用,试着创建一个将`~/.icons/default/cursors` (假设*为指定用户*安装)指向`.local/share/icons/*cursor_theme_name*/cursors`的符号链接然后再次重启 X。
